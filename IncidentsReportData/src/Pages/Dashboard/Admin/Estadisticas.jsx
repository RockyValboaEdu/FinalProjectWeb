    ...
    return (
        <Box sx={{ display: 'flex', minHeight: '100vh', background: '#f5f6fa', overflow: 'hidden' }}>
            ...
            <Box component="main" sx={{
                ...
                <Toolbar />
                <Box sx={{ flexGrow: 1, p: { xs: 2, sm: 3 }, width: '100%', boxSizing: 'border-box' }} id="seccion-imprimible">
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 1 }}>
                        <Box>
                            ...
                            <Typography sx={{ fontWeight: 700, fontSize: { xs: '18px', sm: '22px' }, color: '#1a1a2e', mt: 0.5 }}>
                                Estadísticas del Sistema
                            </Typography>
                        </Box>
                        <Button onClick={() => window.print()} variant="outlined" startIcon={<PrintIcon />}
                            sx={{ borderRadius: '10px', textTransform: 'none', fontWeight: 600, borderColor: '#2e7d32', color: '#2e7d32', '&:hover': { background: 'rgba(46,125,50,0.06)' } }}>
                            Imprimir reporte
                        </Button>
                    </Box>

                    <Card sx={{ p: { xs: 2, sm: 3 }, borderRadius: '16px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0px 4px 20px rgba(0,0,0,0.06)', mb: 3, display: 'flex', alignItems: 'center', gap: 3, flexWrap: 'wrap' }}>
                        ...
                        <Box>
                            <Typography sx={{ fontWeight: 700, fontSize: { xs: '15px', sm: '18px' }, color: '#1a1a2e' }}>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 2, mb: 3 }}>
                        ...
                        <Card sx={{ p: { xs: 2, sm: 3 }, borderRadius: '16px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0px 4px 20px rgba(0,0,0,0.06)' }}>
                            <Typography sx={{ fontWeight: 700, fontSize: '15px', color: '#1a1a2e', mb: 2 }}>Incidentes por Estado</Typography>
                        ...
                        <Card sx={{ p: { xs: 2, sm: 3 }, borderRadius: '16px', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0px 4px 20px rgba(0,0,0,0.06)' }}>
                            <Typography sx={{ fontWeight: 700, fontSize: '15px', color: '#1a1a2e', mb: 2 }}>Incidentes por Tipo</Typography>
