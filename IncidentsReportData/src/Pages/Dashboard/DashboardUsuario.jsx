...
export default function DashboardUsuario() {
    ...
    // Cargar datos del usuario y sus reportes al montar
    React.useEffect(() => {
    ...
    return (
        <Box sx={{ display: 'flex', minHeight: '100vh', background: '#f5f6fa' }}>
            ...
            >
                <Toolbar /> {/* Espaciado bajo el Navbar */}
                ...
                <Box sx={{ flexGrow: 1, p: { xs: 2, sm: 3 } }}>
                    ...
                    {/* Botón Reportar Nuevo Incidente */}
                    <Card
                        ...
                        sx={{
                            ...
                            '&:hover': { boxShadow: '0px 8px 30px rgba(46,125,50,0.15)' },
                            transition: 'all 0.3s',
                        }}
                    >
                        <Box sx={{
                                    ...
                                    <TableRow sx={{ background: '#f9fafb' }}>
                                        {['Tipo', 'Descripción', 'Ubicación', 'Fecha', 'Estado', 'Acciones'].map((col) => (
                                            <TableCell key={col} sx={{
                                                ...
                                                color: '#555', borderBottom: '1px solid rgba(0,0,0,0.06)',
                                            }}>
                                                {col}
                                            </TableCell>
                                        ))}
                                        ...
                                        reportesFiltrados.map((reporte) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell sx={{ fontSize: '13px', color: '#333', maxWidth: 200 }}>
