            ...
            {passwordRequirements.map((req) => {
                ...
                return (
                    <Box key={req.label} sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
                        ...
                        <Typography variant="body2" sx={{ fontSize: '12px', color: ok ? '#2e7d32' : '#555' }}>
                            {req.label}
                        </Typography>
                    </Box>
                );
...
//Mostrar contraseña
    ...
    const validate = () => {
        ...
        if (!form.telefono.trim() || !/^[0-9]{7,10}$/.test(form.telefono))
            newErrors.telefono = 'Ingresa un número de teléfono válido (7 a 10 dígitos).';
                ...
                <Card variant="outlined">
                    ...
                    <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        ...
                        <FormControl>
                            ...
                            <StyledTextField
                                id="apellidos" required fullWidth
                        ...
                        <FormControl>
                            ...
                            <StyledTextField
                                id="identificacion" required fullWidth
                        ...
                        <FormControl>
                            ...
                            <StyledTextField
                                id="telefono" required fullWidth
                        ...
                        <FormControl error={!!errors.genero}>
                            ...
                            <StyledSelect
                                ...
                                displayEmpty
                                renderValue={(val) => val || 'Seleccione la respuesta'}
                            >
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                        <Button
                            ...
                            sx={{
                                py: 1.2, borderRadius: '8px',
                                borderColor: 'rgba(0,0,0,0.15)', color: '#333', fontWeight: 500,
                        ...
                        <Typography sx={{ textAlign: 'center', fontSize: '14px', color: '#555' }}>
                            ¿Ya tienes cuenta?{' '}
                            <RouterLink to="/login" style={{ fontWeight: 600, color: '#1976d2', textDecoration: 'none' }}>
                                Inicia sesión
                            </RouterLink>
                        </Typography>
                    </Box>
