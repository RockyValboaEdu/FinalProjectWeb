...
export default function Navbar({ userName, rol }) {
    ...
    const handleAbrirNotificaciones = (e) => {
        ...
        >
            <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', px: { xs: 2, sm: 3 } }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    {/* Notificaciones */}
                    <IconButton onClick={handleAbrirNotificaciones} sx={{ color: '#555' }}>
                    ...
                    <Popover
                        ...
                        PaperProps={{ sx: { borderRadius: '12px', minWidth: 320, maxWidth: 360, boxShadow: '0px 8px 30px rgba(0,0,0,0.12)' } }}
                    >
                        {/* Header popover */}
                        <Box sx={{ px: 2.5, py: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            {notificaciones.length > 0 && (
                                <Button
                                    ...
                                    sx={{ fontSize: '11px', textTransform: 'none', color: '#2e7d32', fontWeight: 600 }}
                                >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
                            ...
                            <Chip
                                label={rol === 'admin' ? 'Administrador' : 'Usuario'}
                                size="small"
                                sx={{
                                    height: '18px', fontSize: '10px', fontWeight: 600,
                                    background: rol === 'admin' ? '#c62828' : '#2e7d32',
                                    color: '#fff', '& .MuiChip-label': { px: 1 },
                                }}
                            />
                        </Box>
                    </Box>
                    ...
                    <Box
                        ...
                        sx={{
                            ...
                            border: '1px solid rgba(198,40,40,0.3)', color: '#c62828',
                            '&:hover': { background: 'rgba(198,40,40,0.06)' }, transition: 'all 0.2s',
                        }}
                    >
                        <Typography sx={{ fontSize: '13px', fontWeight: 600, color: '#c62828' }}>
                            Cerrar sesión
                        </Typography>
                    </Box>
                </Box>
